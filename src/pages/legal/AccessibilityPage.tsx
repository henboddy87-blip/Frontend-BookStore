  ...
  return (
    ...
    >
      ...
      <Section title="3. Accessibility Features">
        ...
        <ul className="list-disc pl-5 mt-2 space-y-1 text-amber-900/70 dark:text-gray-400">
      ...
      <Section title="5. Feedback and Support">
        ...
        <ul className="list-disc pl-5 mt-2 space-y-1 text-amber-900/70 dark:text-gray-400">
          <li>Email: <a href="mailto:accessibility@bookstore.com" className="text-amber-600 hover:text-amber-800 underline transition-colors">accessibility@bookstore.com</a></li>
          <li>Phone: +1 (555) 123-4567</li>
          <li>Or via our <Link to="/contact" className="text-amber-600 hover:text-amber-800 underline transition-colors">Contact Us</Link> page.</li>
        </ul>
        <p className="mt-2">
