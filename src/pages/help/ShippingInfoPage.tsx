    ...
    <PageLayout>
      ...
      <div className="max-w-4xl mx-auto px-4 py-16 grid md:grid-cols-2 gap-6">
        <InfoCard icon={Clock} title="Processing Time">
          <p className="text-sm text-amber-900/70 dark:text-gray-400 leading-relaxed">
        ...
        <InfoCard icon={Truck} title="Domestic Shipping">
          <div className="space-y-3 mt-2 text-sm text-amber-900/70 dark:text-gray-400">
            <div className="flex justify-between border-b border-amber-100 dark:border-white/5 pb-2">
              <span>Standard (3-5 days)</span>
              <span className="font-bold text-amber-950 dark:text-gray-200">$4.99</span>
            </div>
            <div className="flex justify-between border-b border-amber-100 dark:border-white/5 pb-2">
              <span>Express (1-2 days)</span>
              <span className="font-bold text-amber-950 dark:text-gray-200">$12.99</span>
            </div>
