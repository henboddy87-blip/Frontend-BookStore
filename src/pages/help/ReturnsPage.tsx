    ...
    <PageLayout>
      ...
      <div className="max-w-4xl mx-auto px-4 py-16 grid md:grid-cols-2 gap-6">
        ...
        <InfoCard icon={Mail} title="How to Return">
          <div className="text-sm text-amber-900/70 dark:text-gray-400 leading-relaxed">
            <ol className="list-decimal pl-4 space-y-2">
              <li>Contact us at <Link to="/contact" className="text-amber-600 hover:underline">returns@bookstore.com</Link></li>
        ...
        <InfoCard icon={RotateCcw} title="Condition Requirements">
          <ul className="list-disc pl-4 space-y-2 text-sm text-amber-900/70 dark:text-gray-400">
