            ...
            <div className="bg-white dark:bg-dark-card rounded-3xl shadow-sm border border-gray-100 dark:border-white/5 p-6 sticky top-24">
              ...
              <div className="text-center mb-8">
                <div className="relative inline-block group">
                  <div className="w-32 h-32 bg-gradient-to-br from-amber-700 to-amber-900 rounded-full flex items-center justify-center mx-auto mb-4 shadow-xl overflow-hidden border-4 border-white dark:border-dark-bg">
                    {user.avatar ? (
                  ...
                  <button 
                    ...
                    className="absolute bottom-4 right-0 w-10 h-10 bg-amber-600 hover:bg-amber-500 text-white rounded-full flex items-center justify-center shadow-lg transition-transform hover:scale-110 cursor-pointer border-2 border-white dark:border-dark-bg"
                ...
                {orders.length === 0 ? (
                  ...
                  <div className="space-y-4">
                    {orders.map((order) => {
                      ...
                      return (
                        <div key={order.id} className="bg-gray-50 dark:bg-dark-bg border border-gray-100 dark:border-white/5 rounded-2xl p-5 hover:border-amber-200 dark:hover:border-amber-900/50 transition-colors">
                          <div className="flex flex-wrap items-center justify-between gap-4 mb-4 pb-4 border-b border-gray-200 dark:border-white/5">
                            ...
                            <div className="text-right">
                              ...
                              <p className="text-lg font-black text-amber-700 dark:text-amber-400">{order.total}</p>
                            </div>
                          </div>
                          ...
                          <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                            ...
                            <button className="px-5 py-2.5 bg-white dark:bg-white/5 border border-gray-200 dark:border-white/10 hover:border-amber-500 dark:hover:border-amber-500 rounded-lg text-sm font-semibold text-gray-700 dark:text-gray-200 hover:text-amber-700 dark:hover:text-amber-400 transition-all flex items-center gap-2 flex-shrink-0">
