            ...
            <div className="relative z-10 flex w-full">
              ...
              <div className="w-2/3 pl-6 sm:pl-10 flex flex-col justify-center text-white">
                <h3 className="text-2xl sm:text-3xl font-black mb-3 leading-tight" style={{ fontFamily: "Merriweather, serif" }}>
                  Books Make<br/>Great Gifts
                </h3>
                <p className="text-white/80 text-sm sm:text-base leading-relaxed">
                  Why not send a gift card, book or kindle to loved ones.
                </p>
                <Link to="/gift-cards" className="inline-block mt-4 text-white font-bold text-sm hover:underline underline-offset-4">
                  Shop Gift Cards →
                </Link>
              </div>
            </div>
            ...
            <div className="relative z-10 flex w-full">
              ...
              <div className="w-3/5 pl-4 sm:pl-8 flex flex-col justify-center text-white">
                ...
                <div>
                  <Link 
                    to="/bestsellers" 
                    className="inline-block bg-white text-[#d79737] dark:text-amber-800 px-6 py-2.5 rounded-full font-bold text-sm hover:shadow-lg hover:bg-gray-50 transition-all active:scale-95"
                  >
                    Shop Now
                  </Link>
                </div>
