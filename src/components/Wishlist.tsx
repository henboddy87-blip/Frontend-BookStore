          ...
          {wishlist.length === 0 ? (
            <div className="text-center py-16">
              <div className="w-24 h-24 bg-red-50 dark:bg-red-900/10 rounded-full flex items-center justify-center mx-auto mb-4">
                <FaHeart className="text-red-200 dark:text-red-400/30 text-4xl" />
              </div>
              <h3
              ...
              {wishlist.map((book) => (
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    <button
                      ...
                      className="mt-3 w-full py-2.5 bg-amber-800 text-white text-xs rounded-xl font-bold hover:bg-amber-700 transition-all flex items-center justify-center gap-2 cursor-pointer"
                    >
