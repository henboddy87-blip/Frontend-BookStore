  ...
  return (
    <div className="fixed inset-0 z-50 overflow-hidden">
      ...
      <div className="absolute right-0 top-0 h-full w-full max-w-md bg-white dark:bg-dark-bg shadow-2xl flex flex-col animate-slideInRight">
        {/* Header */}
        <div className="flex items-center justify-between p-6 border-b dark:border-white/5 bg-amber-50 dark:bg-dark-card">
        ...
        {cart.length > 0 && cartTotal < 35 && (
          <div className="px-6 py-3 bg-amber-50 dark:bg-amber-900/10 border-b dark:border-white/5">
        ...
        <div className="flex-1 overflow-y-auto p-6">
          {cart.length === 0 ? (
            <div className="text-center py-16">
              <div className="w-24 h-24 bg-amber-50 dark:bg-amber-900/20 rounded-full flex items-center justify-center mx-auto mb-4">
              ...
              <button
                onClick={onClose}
                className="px-6 py-3 bg-amber-800 text-white rounded-xl font-bold hover:bg-amber-700 transition-all cursor-pointer"
              >
                Browse Books
              </button>
            </div>
            ...
            <div className="space-y-4">
              {cart.map((item, idx) => (
                <div
                  ...
                  className="flex gap-4 bg-gray-50 dark:bg-white/5 rounded-2xl p-4 group hover:bg-amber-50 dark:hover:bg-white/10 transition-colors"
                >
                    ...
                    <div className="flex items-center justify-between mt-3">
                      <div className="flex items-center border border-gray-200 dark:border-white/10 rounded-xl bg-white dark:bg-dark-card overflow-hidden">
                        <button
                          ...
                          className="px-3 py-2 hover:bg-gray-100 dark:hover:bg-white/10 transition-colors dark:text-gray-300"
                        >
                          <FaMinus size={10} />
                        </button>
                      ...
                      <p className="font-black text-gray-900 dark:text-amber-400">
        ...
        {cart.length > 0 && (
          <div className="border-t dark:border-white/5 p-6">
              ...
              <div className="flex gap-2">
                <div className="relative flex-1">
                  ...
                  <input
                    ...
                    className={`w-full pl-9 pr-3 py-3 border-2 rounded-xl text-sm focus:outline-none transition-all ${promoApplied ? "border-emerald-500 bg-emerald-50 dark:bg-emerald-900/20" : promoError ? "border-red-400" : "border-gray-200 dark:border-white/10 bg-white dark:bg-dark-card focus:border-amber-500"}`}
                  />
                </div>
                <button
                  onClick={handlePromo}
            ...
            <button
              onClick={onCheckout}
              className="w-full py-4 bg-amber-800 hover:bg-amber-700 text-white rounded-xl font-bold flex items-center justify-center gap-3 shadow-xl shadow-amber-900/20 transition-all group cursor-pointer"
            >
               Secure Checkout{" "}
